...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-bg-tertiary text-text-primary hover:bg-bg-tertiary/80 focus:ring-bg-tertiary',
    danger: 'bg-accent-danger text-white hover:bg-accent-danger/90 focus:ring-accent-danger',
    ghost: 'bg-transparent text-text-primary hover:bg-bg-secondary focus:ring-bg-tertiary',
  };
